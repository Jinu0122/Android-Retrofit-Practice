...
import com.jnu.unsplash_app_tutorial.utlis.isJsonObject
       ...
       val client = OkHttpClient.Builder()
        ...
        val baseParameterInterceptor : Interceptor = (object : Interceptor{
            ...
            override fun intercept(chain: Interceptor.Chain): Response {
                ...
                // client_id = "asdfasdf"
                // 쿼리 파라메터 추가하기
                val addeUrl = originalRequest.url.newBuilder().addQueryParameter("client_id", API.CLIENT_ID).build()
        ...
        // 위에서 설정한 기본파라메 인터셉터를 okhttp 클라이언트에 추가한다
